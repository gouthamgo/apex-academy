...
export const metadata: Metadata = {
  title: 'Testing Strategies - Master Salesforce Testing',
  description: 'Complete testing curriculum covering unit testing fundamentals, test data factories, code coverage strategies, and enterprise testing patterns.',
  keywords: ['Testing', 'Salesforce', 'Unit Tests', 'Code Coverage', 'Test Data', 'Quality Assurance'],
};

export default function TestingStrategiesPage() {
  const topics = getTopicsBySection('testing');
  const sectionData = getSectionData().find(s => s.id === 'testing')!;
  const progress = getTopicProgress('testing');
          ...
          <div className="text-center">
            ...
            <div className="bg-white/10 rounded-lg p-6 max-w-md mx-auto">
              <div className="flex items-center justify-between mb-2">
                <span className="text-green-100">Learning Progress</span>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
            Complete Testing Curriculum
          </h2>
          <p className="text-gray-600 dark:text-gray-400">
            Master Salesforce testing strategies from unit test basics to advanced patterns. Learn test data creation,
            code coverage optimization, mock frameworks, and enterprise testing best practices for bulletproof applications.
          </p>
        </div>
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    ...
                    className="inline-flex items-center px-4 py-2 text-sm font-medium text-green-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300 transition-colors group"
                  >
                    Start Topic
        ...
        {/* Learning Path Info */}
        <div className="mt-12 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border border-green-200 dark:border-green-800 rounded-lg p-8">
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-2xl mx-auto">
              This curriculum is designed to take you from testing beginner to expert. Topics are ordered by complexity
            ...
            <div className="grid md:grid-cols-3 gap-6 text-left">
              <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Unit testing fundamentals, test class structure, assertions, and basic code coverage concepts.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Test data factories, builder patterns, mocking frameworks, and testing different Apex patterns.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Integration testing, test automation, CI/CD pipelines, and enterprise testing strategies.
                </p>
              </div>
            </div>
          </div>
