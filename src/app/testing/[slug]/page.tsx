...
// Generate static params for all Testing topics
...
export async function generateMetadata({ params }: TopicPageProps): Promise<Metadata> {
  const topic = getTopicBySlug(params.slug, 'testing');
  ...
  return {
    title: `${topic.frontmatter.title} - Testing Strategies`,
    description: topic.frontmatter.description,
    keywords: topic.frontmatter.concepts.join(', '),
  };
}

export default async function TestingTopicPage({ params }: TopicPageProps) {
  const topic = getTopicBySlug(params.slug, 'testing');
  ...
  const allTopics = getTopicsBySection('testing');
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <article className="flex-1 max-w-none">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {previousTopic ? (
                <Link
                  href={`/testing/${previousTopic.slug}`}
              ...
              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
                ...
                <div className="space-y-4">
                  {relatedTopics.map((relatedTopic) => (
                    ...
                    >
                      <h4 className="text-sm font-medium text-gray-900 dark:text-white group-hover:text-green-600 dark:group-hover:text-green-400 transition-colors mb-1">
