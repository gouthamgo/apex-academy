...
export const metadata: Metadata = {
  title: 'Apex Fundamentals - Master Salesforce Programming',
  description: 'Complete Apex curriculum covering variables, collections, OOP, database operations, triggers, and advanced patterns with detailed examples.',
  keywords: ['Apex', 'Salesforce', 'Programming', 'Development', 'Variables', 'Collections', 'Triggers'],
};

export default function ApexFundamentalsPage() {
  const topics = getTopicsBySection('apex');
  const sectionData = getSectionData().find(s => s.id === 'apex')!;
  const progress = getTopicProgress('apex');
