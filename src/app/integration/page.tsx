...
export const metadata: Metadata = {
  title: 'Integration Patterns - Master Salesforce Integrations',
  description: 'Complete integration curriculum covering REST APIs, SOAP, Platform Events, authentication, and enterprise integration patterns with detailed examples.',
  keywords: ['Integration', 'Salesforce', 'REST API', 'SOAP', 'Platform Events', 'OAuth'],
};

export default function IntegrationPatternsPage() {
  const topics = getTopicsBySection('integration');
  const sectionData = getSectionData().find(s => s.id === 'integration')!;
  const progress = getTopicProgress('integration');
          ...
          <div className="text-center">
            ...
            <div className="bg-white/10 rounded-lg p-6 max-w-md mx-auto">
              <div className="flex items-center justify-between mb-2">
                <span className="text-orange-100">Learning Progress</span>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Master Salesforce integration patterns from fundamentals to advanced architectures. Learn REST APIs, SOAP services,
            Platform Events, authentication strategies, and enterprise integration best practices.
          </p>
        </div>
            ...
            >
              <div className="p-6">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold text-gray-900 dark:text-white group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-colors">
                        <Link href={`/integration/${topic.slug}`}>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    href={`/integration/${topic.slug}`}
                    className="inline-flex items-center px-4 py-2 text-sm font-medium text-orange-600 dark:text-orange-400 hover:text-orange-700 dark:hover:text-orange-300 transition-colors group"
                  >
                    Start Topic
        ...
        {/* Learning Path Info */}
        <div className="mt-12 bg-gradient-to-r from-orange-50 to-amber-50 dark:from-orange-900/20 dark:to-amber-900/20 border border-orange-200 dark:border-orange-800 rounded-lg p-8">
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-2xl mx-auto">
              This curriculum is designed to take you from integration beginner to expert. Topics are ordered by complexity
            ...
            <div className="grid md:grid-cols-3 gap-6 text-left">
              <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Integration fundamentals, HTTP basics, and understanding REST vs SOAP architectures.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Platform Events, authentication strategies (OAuth, JWT), and Named Credentials configuration.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Enterprise integration patterns, error handling, retry logic, and real-time event-driven architectures.
                </p>
              </div>
            </div>
          </div>
