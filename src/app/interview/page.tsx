...
export const metadata: Metadata = {
  title: 'Interview Preparation - Ace Your Salesforce Interviews',
  description: 'Comprehensive interview questions and answers for Salesforce roles. Covering Salesforce Basics, Apex, LWC, Integration, and behavioral questions.',
  keywords: ['Salesforce Interview', 'Interview Questions', 'Apex Interview', 'LWC Interview', 'Salesforce Jobs', 'Interview Prep'],
};

export default function InterviewPrepPage() {
  const topics = getTopicsBySection('interview');
  const sectionData = getSectionData().find(s => s.id === 'interview')!;
  const progress = getTopicProgress('interview');
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Ace your Salesforce interviews with comprehensive questions and detailed answers. Covers technical questions,
            scenario-based problems, and best practices for answering interview questions.
          </p>
        </div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold text-gray-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                        <Link href={`/interview/${topic.slug}`}>
        ...
        <div className="mt-12 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-8">
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-2xl mx-auto">
              These interview guides cover everything from fundamentals to advanced topics. Each guide includes
              real questions asked in interviews, detailed answers, and tips for success.
            </p>

            <div className="grid md:grid-cols-3 gap-6 text-left">
              <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                <div className="text-green-600 dark:text-green-400 text-2xl mb-2">📚</div>
                <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Technical Questions</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  In-depth technical questions covering Salesforce platform, Apex, LWC, integration, and testing.
                </p>
              </div>

              <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                <div className="text-blue-600 dark:text-blue-400 text-2xl mb-2">💡</div>
                <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Scenario-Based</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Real-world scenarios and problem-solving questions that test your practical knowledge.
                </p>
              </div>

              <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                <div className="text-purple-600 dark:text-purple-400 text-2xl mb-2">✨</div>
                <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Behavioral</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Behavioral questions, STAR method examples, and tips for presenting your experience effectively.
                </p>
              </div>
            </div>
          </div>
